...
/**
 * 自定义请求响应类型，用于提供调用提示
 * @typedef {Promise<{code,result,message}>} CustomPromise
 * @type {(config:AxiosRequestConfig)=>CustomPromise}
 */

/**
 * @type { (options) => CustomPromise }
 */
...
const getAction = (url, params) => service({ method: 'get', url, params });
const postAction = (url, params) => service({ method: 'post', url, data: params })
